...
# ╔═╡ 46c0f8e5-f26f-467a-bd30-974c8b71c518
md"""고유값 행렬이라고 볼 수 있다~ 정도"""
...
# ╔═╡ 099750e9-8de9-4ab7-baa3-24d8269779bc
let 
	A = [1 2 ; 2 1]
	eigen(A)
end
...
# ╔═╡ d5ef8861-b364-4ff2-9ced-3ad310b688f6
let
	A = [0 0
		0 0]
	v1, v2 = [eigvecs(A)[:,i] for i in 1:2]
	Ax, Ay = c1*v1 + c2*v2
	scatter(xlim=(-11,11),ylim=(-11,11))
	scatter!([Ax],[Ay],markershape=:cross,color=:"red")
end

# ╔═╡ 30a46f8f-72cd-4705-8ff8-44a8e946e081
md""" 2차원
"""
