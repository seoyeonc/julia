...
# ╔═╡ 779ced1b-a307-47d4-b10f-e7d22757ae1e
scatter(_Z[:,1],_Z[:,2],markersize=0.2

# ╔═╡ e88ae92a-01dd-4b04-b32e-1f39f09fd5ac
#UU,dd,VV = svd(X'X) 
#_VV = [VV[:,1] -VV[:,2] VV[:,3]] # 두번쨰 컬럼의 부호를 임의로 바꿔버렸음 
#_Z = X * _VV[:,1:2] # 부호를 바꾼 V2으로 Z를 구함
md"""
두 개의 그룹이 잘 구분되는 모습, 부호를 넣어줘도 잘 구분된다는 것을 확인할 수 있었다.
"""
