...
# ╔═╡ ac991631-b6a8-463a-a25d-7ef3f542450c
md"Distributions 분포 함수 쓰는 패키지, Plots 그림 그리는 패키지"
...
# ╔═╡ d400d0a3-0dc7-4827-a83a-27af08b52fc4
md"벡터니까 . 넣어서 브로드캐스팅 해주자"
...
# ╔═╡ f0322edc-be7c-48cd-a4d8-5c274c4858d3
md"let/end 안에서만 x가 사용됨! 밖이랑 연관되지 않음"
...
# ╔═╡ 2ef779e4-faee-4ea9-b529-fbbed3ca53cf
let
	n=100
	p=0.37
	X=rand(Bernoulli(p),n)
...
# ╔═╡ 67885d1d-2fb4-442b-8289-fb20fc075177
md"방법1"

# ╔═╡ a81ac37a-8eed-4ba1-8184-1d65306496fe
histogram(rand(Binomial(30,0.45),100))

# ╔═╡ ab184472-386c-4b5d-929b-d9e58614a4bd
md"방법 2"

# ╔═╡ 2c65804c-999c-4812-a14a-4da516044e64
histogram([rand(30) .< 0.45 for i in 1:100] .|> sum)

# ╔═╡ 563fa8d6-26cb-4576-8c7d-5c5198d8077e
md"방법 3"

# ╔═╡ 847eea13-f6d0-45a5-8e8c-1854f17fc223
