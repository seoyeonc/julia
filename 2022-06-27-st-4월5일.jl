...
md"""
`-` 방법3
- 이론: $\bar{X},\bar{Y} \overset{iid}{\sim} N(0,\frac{1}{3}) \Rightarrow \sqrt{3}\bar{X}, \sqrt{3}\bar{Y} \overset{iid}{\sim} N(0,1) \Rightarrow \frac{2}{3}(\bar{X}^2+\bar{Y}^2)\sim Exp(1)$
"""
...
# ╔═╡ 70fcd0fa-555c-43bc-958f-e2481515b695
md"풀이 1"

# ╔═╡ 06775805-eff7-4d93-b80a-8bcc61ced90e
let
	c2= quantile([rand(Normal(0,10),25) |> mean for i in 1:1000000],0.935) 
	xbar2 = 67.53 
	(xbar2-c2, xbar2+c2)
end 

# ╔═╡ cc3b6e10-954f-4675-a2a6-8cba501a96dd
md"풀이 2"

# ╔═╡ 8bb4a3a1-9c92-4f4c-8068-51e4ba5440c0
let 
	n2=25 
	σ2=10 
	c2= quantile(Normal(0,σ2/√n2),0.935)
	xbar2 = 67.53 
	(xbar2-c2, xbar2+c2)
end 
